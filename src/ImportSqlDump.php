...
class ImportSqlDump extends \Robo\Task\BaseTask implements \Robo\Contract\BuilderAwareInterface {

    use BaseTasks, FileTasks, DynamicParams, CAGTasks, BuilderAwareTrait;
	...
	public function run()
	{
		...
		// Run the command
		if (!$collection->taskExec($cmd)->run()->wasSuccessful())
		{
			throw new RuntimeException
			(
